...
namespace GMath {
/*
 * Subclass of GMath::Matrix with a constant shape of 2x2.
 */
template <typename value_t> class Matrix2 : public Matrix<value_t> {
private:
  /*
   * Disabled Reshape() method for a 2x2 matrix.
   */
